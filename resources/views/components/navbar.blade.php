    ...
    <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center justify-start">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <img src="{{ Vite::asset('resources/images/logo.svg') }}" class="h-8 mr-3" alt="CheckQR Logo" />
                <span
                    class="self-center hidden text-2xl font-semibold sm:block whitespace-nowrap dark:text-white">CheckQR</span>
            </a>
            <form method="GET" action="/search" class="hidden md:block md:pl-2">
        ...
        <div class="flex items-center lg:order-2">
            ...
            @auth
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full" src="{{ Vite::asset('resources/images/logo.svg') }}"
                        alt="user photo" />
                </button>
                <!-- Dropdown menu -->
                <div class="z-50 hidden w-56 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    ...
                    @auth
                        <div class="px-4 py-3">
                            <span
                                class="block text-sm font-semibold text-gray-900 dark:text-white">{{ Auth::user()->first_name . ' ' . Auth::user()->middle_name . ' ' . Auth::user()->last_name }}</span>
                            <span class="block text-sm text-gray-900 truncate dark:text-white">{{ Auth::user()->email }}</span>
                            <span
                                class="block text-sm text-gray-900 truncate dark:text-white">{{ Auth::user()->account_type }}</span>
                        </div>
                    @endauth
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <a href="/portfolio/{{ Auth::id() }}"
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex items-center">
                            <svg aria-hidden="true" class="w-5 h-5 mr-2 text-primary-600 dark:text-primary-500"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <button href="/logout" form="logout-form" type="submit"
                                class="block w-full px-4 py-2 text-sm text-left hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sign
                                out</button>
                        </li>
