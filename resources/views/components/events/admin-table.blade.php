                ...
                <tbody>
                    {{-- @foreach ($applications as $application) --}}
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3"> 07:00am </td>
                            {{-- <td class="px-4 py-3"><a href="/portfolio/{{ $application->applicant_id }}" target="_blank">Check</a></td> --}}
                            <td class="px-4 py-3"> 09:00am </td>
                            <td class="px-4 py-3"> Open </td>
                            <td class="px-4 py-3"> Attended </td>
                            <td class="px-4 py-3"> {{ now() }} </td>
                            <td class="flex items-center justify-end px-4 py-3">
                                <button id="{{ 1 }}-dropdown-button"
                                    data-dropdown-toggle="{{ 1 }}-dropdown"
                                ...
                                <div id="{{ 1 }}-dropdown"
                                    ...
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="#" id="{{ 1 }}ApproveButton"
                                                data-modal-target="{{ 1 }}ApproveModal"
                                                data-modal-toggle="{{ 1 }}ApproveModal"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Approve</a>
                                        </li>
                                        <li>
                                            <a href="#" id="{{ 1 }}RejectButton"
                                                data-modal-target="{{ 1 }}RejectModal"
                                                data-modal-toggle="{{ 1 }}RejectModal"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Reject</a>
                                        </li>
                                    </ul>
                                    {{-- <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Reject</a>
                                </div> --}}
                                </div>
                            </td>
                        </tr>
                        <x-application.modal name="{{ 1 }}Approve" inputId1="application_id"
                            inputId2="applicant_id" data1="{{ 1 }}" data2="{{ 1 }}" cancelMessage="No, cancel"
                            confirmMessage="Yes, I'm sure" message="Are you sure you want to confirm?"
                            formAction="/application-approve" formMethod="PATCH" type="default">
                            <x-slot name="icon">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white mb-3.5 mx-auto"
                        ...
                        <x-application.modal name="{{ 1 }}Reject" inputId1="application_id"
                            inputId2="applicant_id" data1="{{ 1 }}" data2="{{ 1 }}" cancelMessage="No, cancel"
                            confirmMessage="Yes, I'm sure" message="Are you sure you want to reject?"
                            formAction="/application-reject" formMethod="PATCH" type="warning">
                            <x-slot name="icon">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white mb-3.5 mx-auto"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" fill="none" viewBox="0 0 24 24">
