<footer class="bg-white rounded-lg shadow sm:flex mt-4 sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; {{ date('Y') }} <x-ui.link>CheckQR</x-ui.link>. All rights reserved.
    </p>
    <div class="flex justify-center items-center space-x-1">
      <x-ui.link to="https://www.facebook.com/luisito.velasco.23" data-tooltip-target="tooltip-facebook" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
          <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
              <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
          </svg>
          <span class="sr-only">Facebook</span>
      </x-ui.link>
      <x-ui.tool-tip id="tooltip-facebook">
        Like us on Facebook
      </x-ui.tool-tip>
